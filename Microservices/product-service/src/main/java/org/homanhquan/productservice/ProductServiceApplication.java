...
public class ProductServiceApplication {
     ...
     * @Lazy: Tells Spring to create a bean only when it’s first needed, instead of at application startup.
     * It helps improve startup time and save resources, especially for heavy or rarely used beans, but delays error detection until the bean is actually used.
     * ==================================================

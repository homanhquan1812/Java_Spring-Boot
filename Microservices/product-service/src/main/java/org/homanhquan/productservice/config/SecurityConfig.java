...
/**
 * Spring Security is a security framework for Spring applications that provides authentication (verifying user identity)
 * and authorization (access control) through a chain of security filters.
 * ==================================================
